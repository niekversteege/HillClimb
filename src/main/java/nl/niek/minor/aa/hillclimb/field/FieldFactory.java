...
public class FieldFactory
{
	...
	public static RightDownField getDefaultField()
	{
		...
		int[] row5 = new int[] { 1, 9, 2, 6, 2, 9, 3, 5, 7, 3 };
		int[] row6 = new int[] { 1, 9, 2, 6, 2, 9, 3, 5, 7, 5 };
		int[] row7 = new int[] { 1, 9, 2, 6, 2, 9, 3, 5, 7, 3 };
		int[] row8 = new int[] { 1, 9, 2, 6, 2, 9, 3, 5, 7, 6 };
		int[] row9 = new int[] { 1, 9, 2, 6, 2, 9, 3, 5, 7, 0 };
